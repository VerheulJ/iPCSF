...
// ============================================
//
// This C++ implementation is adapted from the PCSF R package
// by Murodzhon Akhmedov et al. (2017), originally licensed under MIT License.
//
// Original package: https://github.com/IOR-Bioinformatics/PCSF
// Citation: Akhmedov M, et al. (2017). A Fast Prize-Collecting Steiner Forest
//   Algorithm for Functional Analyses in Biological Networks.
...
//'
// [[Rcpp::export]]
List call_sr(CharacterVector from, CharacterVector to, NumericVector cost,
             CharacterVector node_names, NumericVector node_prizes)
{
  clear_variables();
  ...
  double obj = cut(Root, spanning_tree, tree_from, tree_to, tree_cost, tree_terminals);
  if (obj == 0) return 0;
